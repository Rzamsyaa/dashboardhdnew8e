...
const schedules = [
  { patient: "Ahmad Fauzan", session: "Pagi",  machine: "HD-01", start: "07:00", end: "11:00", status: "Selesai",     note: "Prosedur berjalan lancar" },
  { patient: "Siti Nurhaliza", session: "Pagi",  machine: "HD-02", start: "07:05", end: "11:05", status: "Selesai", note: "-" },
  { patient: "Tarinah", session: "Pagi",  machine: "HD-04", start: "07:10", end: "11:10", status: "Berlangsung",  note: "HD berlangsung" },
  { patient: "Budi Santoso", session: "Pagi",  machine: "HD-05", start: "07:20", end: "11:24", status: "Selesai",     note: "Monitoring rutin" },
  { patient: "Dewi Lestari", session: "Pagi",  machine: "HD-06", start: "07:26", end: "11:30", status: "Menunggu",    note: "Menunggu asesmen pra-HD" },
  { patient: "Muhammad Rizky", session: "Pagi",  machine: "HD-03", start: "07:37", end: "11:40", status: "Batal",       note: "Mesin maintenance" },
  { patient: "Rina Marlina", session: "Pagi",  machine: "HD-01", start: "07:41", end: "11:47", status: "Menunggu",   note: "Menunggu verifikasi pasca maintenance" },
  { patient: "Andi Saputra", session: "Pagi",  machine: "HD-02", start: "07:50", end: "11:50", status: "Terjadwal",   note: "Dijadwalkan masuk setelah HD-02 selesai" },

  { patient: "Fitri Handayani", session: "Siang", machine: "HD-01", start: "12:30", end: "16:25", status: "Terjadwal",   note: "Persiapan sterilisasi" },
  { patient: "Eko Prasetyo", session: "Siang", machine: "HD-02", start: "12:45", end: "16:48", status: "Terjadwal",   note: "Pasien sudah mengonfirmasi kehadiran" },
  { patient: "Nabila Putri", session: "Siang", machine: "HD-03", start: "13:53", end: "17:55", status: "Batal",   note: "Pasien berhalangan datang" },
  { patient: "Intan Permata", session: "Siang", machine: "HD-04", start: "12:40", end: "16:43", status: "Menunggu",    note: "Menunggu asesmen pra-HD & persetujuan dokter" },
  { patient: "Fajar Nugroho", session: "Siang", machine: "HD-05", start: "12:33", end: "16:35", status: "Menunggu",   note: "Sedang proses verifikasi berkas" },
  { patient: "Lilis Suryani", session: "Siang", machine: "HD-06", start: "12:49", end: "16:51", status: "Terjadwal",   note: "Pasien dalam perjalanan" },
  { patient: "Adi Hidayat", session: "Siang", machine: "HD-01", start: "12:44", end: "16:41", status: "Batal",       note: "Konfirmasi pembatalan pasien" },
  { patient: "Maya Sari", session: "Siang", machine: "HD-05", start: "12:37", end: "16:40", status: "Terlambat",  note: "Belum hadir sesuai jadwal" }
];
